                                ...
                                <div class="flex-1 relative overflow-hidden bg-white/30" id="mockup-viewport">
                                    <div id="mockup-scroll-content" class="absolute top-0 left-0 w-full p-6 pb-6 flex flex-col gap-4 will-change-transform">
                                        ...
                                        <div class="checkout-anim-item opacity-0 flex gap-4 items-center p-3 rounded-2xl bg-white border border-stone-100 shadow-sm" data-anim="left">
                                            <div class="w-16 h-16 rounded-xl overflow-hidden shrink-0"><div class="w-full h-full flex items-center justify-center border-2 border-[#FF8A4D]" style="background: radial-gradient(circle at 35% 30%, #FF8A4D, #FF5E00 60%, #CC4B00);"><span class="font-playfair text-lg text-white">H</span></div></div>
                                        ...
                                        <div class="checkout-anim-item opacity-0 flex gap-4 items-center p-3 rounded-2xl bg-white border border-stone-100 shadow-sm" data-anim="right">
                                            <div class="w-16 h-16 rounded-xl overflow-hidden shrink-0"><div class="w-full h-full flex items-center justify-center border-2 border-stone-300" style="background: radial-gradient(circle at 35% 30%, #E7E5E4, #A8A29E 60%, #78716C);"><span class="font-playfair text-lg text-white">T</span></div></div>
