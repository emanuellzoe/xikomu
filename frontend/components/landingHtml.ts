// Markup ported from the Casa Flow template (provided by the project owner).
// Colors are themed to Claude orange via the recolor pass; structure/assets kept as-is.
    ...
    <nav class="fixed top-0 w-full z-50 bg-[#FAFAFA]/80 backdrop-blur-md border-b border-stone-200/50">
        <div class="lg:px-8 flex h-20 max-w-7xl mr-auto ml-auto pr-6 pl-6 items-center justify-between">
            <div class="flex items-center gap-1 cursor-pointer">
                <span class="text-[#E8A07E] font-light tracking-widest text-2xl uppercase">Casa</span>
                <div class="relative flex items-center">
                    <span class="text-[#C96442] font-normal text-2xl tracking-tight -ml-1">Flow</span>
            ...
            <div class="hidden md:flex items-center gap-8 text-lg font-light text-stone-500">
                <a href="#collections" class="hover:text-stone-900 transition-colors">Collections</a>
                <a href="#payment-section" class="hover:text-stone-900 transition-colors">Process</a>
                <a href="#faq" class="hover:text-stone-900 transition-colors">Insights</a>
            </div>
            ...
            <div class="flex items-center gap-4">
                ...
                <button class="hover:bg-[#A84F2E] transition-all flex text-lg font-normal text-white bg-[#C96442] rounded-full pt-2.5 pr-5 pb-2.5 pl-5 gap-x-2 gap-y-2 items-center">Start Here</button>
            </div>
        </div>
    </nav>
    ...
    <main class="flex-grow pt-20">
        ...
        <section class="lg:px-8 lg:pt-32 lg:pb-32 flex flex-col lg:flex-row gap-16 max-w-7xl mr-auto ml-auto pt-24 pr-6 pb-24 pl-6 relative gap-x-16 gap-y-16 items-center">
            ...
            <div class="flex-1 w-full z-10 relative">
                <div class="inline-flex gap-2 bg-white/50 border-stone-200 border rounded-full mb-8 pt-1 pr-3 pb-1 pl-3 backdrop-blur-sm gap-x-2 gap-y-2 items-center">
                    ...
                    <span class="text-base font-normal text-stone-600">Premium Furnishing without the Financial Pressure</span>
                </div>

                <h1 id="hero-heading" class="lg:text-8xl leading-[1.05] text-6xl tracking-tight mb-8 flex flex-col font-normal">
                    <span class="cta-bounce-enter block text-[#2C2B29] font-playfair">Dream Big.</span>
                    <span class="cta-bounce-enter block text-[#D2754E] font-playfair">Pay Less.</span>
                    <span class="cta-bounce-enter block font-playfair italic text-[#F0C2A6]">Casa Flow.</span>
                </h1>

                <p class="leading-relaxed text-2xl font-light text-stone-500 font-montserrat max-w-2xl mb-10">We source high-quality furniture straight from large-scale factories in China and deliver complete &amp; cost-effective furnishing solutions with easy, customized payment plans</p>

                <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                    <button class="hover:bg-[#A84F2E] transition-all sm:w-auto text-xl font-normal text-white bg-[#C96442] w-full rounded-full pt-4 pr-8 pb-4 pl-8 shadow-xl">Get My Free Design Quote</button>
        ...
        <div class="w-full bg-white border-y border-stone-200 py-3.5 overflow-hidden relative z-20 flex trust-marquee-container shadow-sm">
            ...
            <div class="trust-marquee-content flex gap-8 sm:gap-14 shrink-0 px-4 sm:px-7 items-center">
                <div class="flex items-center gap-2.5 text-stone-600"><iconify-icon icon="solar:verified-check-linear" class="text-[#C96442] text-xl" stroke-width="1.5"></iconify-icon><span class="text-[11px] sm:text-xs uppercase tracking-[0.15em] font-medium font-montserrat">Lowest Prices Guaranteed</span></div>
                <div class="flex items-center gap-2.5 text-stone-600"><iconify-icon icon="solar:pie-chart-2-linear" class="text-[#C96442] text-xl" stroke-width="1.5"></iconify-icon><span class="text-[11px] sm:text-xs uppercase tracking-[0.15em] font-medium font-montserrat">0% Hidden Interest</span></div>
                <div class="flex items-center gap-2.5 text-stone-600"><iconify-icon icon="solar:box-minimalistic-linear" class="text-[#C96442] text-xl" stroke-width="1.5"></iconify-icon><span class="text-[11px] sm:text-xs uppercase tracking-[0.15em] font-medium font-montserrat">Factory Direct Sourcing</span></div>
                <div class="flex items-center gap-2.5 text-stone-600"><iconify-icon icon="solar:shield-check-linear" class="text-[#C96442] text-xl" stroke-width="1.5"></iconify-icon><span class="text-[11px] sm:text-xs uppercase tracking-[0.15em] font-medium font-montserrat">Bank-Grade Security</span></div>
                <div class="flex items-center gap-2.5 text-stone-600"><iconify-icon icon="solar:calendar-date-linear" class="text-[#C96442] text-xl" stroke-width="1.5"></iconify-icon><span class="text-[11px] sm:text-xs uppercase tracking-[0.15em] font-medium font-montserrat">Flexible Pay Up To 5 Years</span></div>
                <div class="flex items-center gap-2.5 text-stone-600"><iconify-icon icon="solar:routing-2-linear" class="text-[#C96442] text-xl" stroke-width="1.5"></iconify-icon><span class="text-[11px] sm:text-xs uppercase tracking-[0.15em] font-medium font-montserrat">End-to-End Delivery</span></div>
            </div>
            ...
            <div class="sticky top-0 h-screen w-full flex flex-col items-center justify-center overflow-hidden px-6">
                ...
                <div id="features-heading" class="relative z-40 text-center mb-10 lg:mb-16 opacity-0 translate-y-8 will-change-transform max-w-4xl mx-auto">
                    <div class="inline-flex bg-white border-stone-200 border rounded-full mb-8 pt-1 pr-3 pb-1 pl-3 shadow-sm gap-x-2 items-center">
                        <span class="w-2 h-2 rounded-full bg-[#E8A07E]"></span>
                        <span class="text-sm font-normal text-stone-600">No Showrooms</span>
                        <span class="w-2 h-2 rounded-full bg-[#E8A07E]"></span>
                        <span class="text-sm font-normal text-stone-600">No Middlemen</span>
                    </div>

                    <h2 class="text-5xl lg:text-7xl leading-[1.05] tracking-tight flex flex-col font-normal items-center text-center">
                        <span class="font-playfair text-[#2C2B29]">Factory-Direct Luxury</span>
                        <span class="font-playfair italic text-[#D2754E]">from China to UAE</span>
                    </h2>
                </div>
                ...
                <div class="relative w-full max-w-[320px] sm:max-w-[360px] h-[380px] lg:h-[460px] z-30 perspective-normal mt-4 lg:mt-0">
                    <div id="feature-card-1" class="absolute inset-0 bg-white rounded-[2rem] p-8 lg:p-10 border border-stone-200 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] flex flex-col will-change-transform origin-bottom z-10">
                        ...
                        <h3 class="text-2xl lg:text-3xl font-normal text-stone-900 tracking-tight mb-4 mt-auto">Interior Design</h3>
                        <p class="leading-relaxed text-sm lg:text-base text-stone-500 font-montserrat font-light">Access professionally curated room concepts. Visualize how superb furniture pieces fit together in your unique space.</p>
                    </div>
                    ...
                    <div id="feature-card-3" class="absolute inset-0 bg-white rounded-[2rem] p-8 lg:p-10 border border-stone-200 shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] flex flex-col will-change-transform origin-bottom z-20">
                        ...
                        <h3 class="text-2xl lg:text-3xl font-normal text-stone-900 tracking-tight mb-4 mt-auto">Easy Payment</h3>
                        <p class="leading-relaxed text-sm lg:text-base text-stone-500 font-montserrat font-light">Break down your purchases into manageable, interest-free installments with our seamless checkout experience.</p>
                    </div>
                    ...
                    <div id="feature-card-2" class="absolute inset-0 bg-[#2C2B29] rounded-[2rem] p-8 lg:p-10 border border-[#3A3936] shadow-[0_24px_48px_-12px_rgba(0,0,0,0.4)] flex flex-col will-change-transform origin-bottom z-30">
                        <div class="w-14 h-14 rounded-2xl border border-[#3A3936] bg-[#1F1E1D] flex items-center justify-center mb-6 shadow-inner"><iconify-icon icon="solar:crown-star-linear" class="text-2xl text-[#E8A07E]"></iconify-icon></div>
                        <h3 class="text-2xl lg:text-3xl font-normal text-white tracking-tight mb-4 mt-auto">Superb Furniture</h3>
                        <p class="leading-relaxed text-sm lg:text-base text-stone-300 font-montserrat font-light">Shop an exclusive catalog of high-quality, sustainably sourced furniture designed to elevate your home.</p>
                    </div>
                </div>
            </div>
        </section>
        ...
        <!-- Dynamic Live Quotation Section -->
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                        ...
                        <div class="order-2 lg:order-1" id="live-quote-text-content">
                            <div class="cta-bounce-enter inline-flex items-center gap-2 mb-6">
                                ...
                                <span class="uppercase text-xs font-medium tracking-widest text-[#C96442] font-montserrat">Live Quotation</span>
                            </div>

                            <h2 class="text-5xl lg:text-6xl font-normal mb-8 leading-[1.05] tracking-tight flex flex-col">
                                <span class="cta-bounce-enter block text-[#2C2B29] font-playfair">Furnish now.</span>
                                <span class="cta-bounce-enter block text-[#D2754E] font-playfair">Pay at your</span>
                                <span class="cta-bounce-enter block font-playfair italic text-[#F0C2A6]">own pace.</span>
                            </h2>

                            <p class="cta-bounce-enter text-xl text-stone-500 font-light leading-relaxed mb-10 font-montserrat">We believe high-quality living spaces shouldn't be a financial burden. Say goodbye to upfront lumpsums. Our interactive portal allows you to review your Bill of Quantities (BOQ) and instantly structure a payment plan that works for you.</p>

                            <ul class="space-y-4 mb-10 text-stone-600">
                                <li class="cta-bounce-enter tick-item flex items-center gap-3"><iconify-icon icon="solar:check-circle-linear" class="text-[#C96442] text-2xl" stroke-width="1.5"></iconify-icon><span class="text-lg font-light font-montserrat">Zero hidden interest on factory prices</span></li>
                                <li class="cta-bounce-enter tick-item flex items-center gap-3"><iconify-icon icon="solar:check-circle-linear" class="text-[#C96442] text-2xl" stroke-width="1.5"></iconify-icon><span class="text-lg font-light font-montserrat">Bank-grade secure checkout</span></li>
                                <li class="cta-bounce-enter tick-item flex items-center gap-3"><iconify-icon icon="solar:check-circle-linear" class="text-[#C96442] text-2xl" stroke-width="1.5"></iconify-icon><span class="text-lg font-light font-montserrat">Pay by milestones</span></li>
                            </ul>
                        </div>
                        ...
                        <div class="order-1 lg:order-2 relative" id="invoice-section">
                            <div class="bg-white/80 backdrop-blur-2xl border border-stone-200 rounded-[2rem] shadow-2xl overflow-hidden relative z-10 flex flex-col h-[550px]">
                                ...
                                <div id="quote-header" class="bg-[#F5F4F2] p-6 border-b border-stone-200 flex justify-between items-end relative z-30 shadow-sm opacity-0 will-change-transform">
                                    <div><p class="text-xs font-medium tracking-widest uppercase text-stone-500 mb-1">Quote #CF-2026</p><h3 class="text-2xl font-normal text-stone-900 tracking-tight">Downtown Penthouse</h3></div>
                                    <div class="text-right"><p class="text-xs font-medium text-stone-500 uppercase tracking-widest mb-1">Total Value</p><p class="text-xl font-normal text-stone-900 tracking-tight">AED 100,000</p></div>
                                </div>
                                ...
                                <div class="flex-1 relative overflow-hidden bg-white/30" id="mockup-viewport">
                                    <div id="mockup-scroll-content" class="absolute top-0 left-0 w-full p-6 pb-6 flex flex-col gap-4 will-change-transform">
                                        ...
                                        <div class="checkout-anim-item opacity-0 flex gap-4 items-center p-3 rounded-2xl bg-white border border-stone-100 shadow-sm" data-anim="left">
                                            <div class="w-16 h-16 rounded-xl overflow-hidden shrink-0"><img src="https://images.unsplash.com/photo-1550581190-9c1c48d21d6c?w=150&h=150&fit=crop" class="w-full h-full object-cover"></div>
                                            <div class="flex-1"><h4 class="font-normal text-stone-900 text-base tracking-tight">Custom Italian Sofa</h4><p class="text-sm text-stone-500 mt-0.5 font-light">3-Seater &bull; Linen</p></div>
                                            <div class="text-right"><p class="text-base font-normal text-stone-900 tracking-tight">AED 12,500</p></div>
                                        </div>
                                        ...
                                        <div class="checkout-anim-item opacity-0 flex gap-4 items-center p-3 rounded-2xl bg-white border border-stone-100 shadow-sm" data-anim="right">
                                            <div class="w-16 h-16 rounded-xl overflow-hidden shrink-0"><img src="https://images.unsplash.com/photo-1532323544230-7191fd51bc1b?w=150&h=150&fit=crop" class="w-full h-full object-cover"></div>
                                            <div class="flex-1"><h4 class="font-normal text-stone-900 text-base tracking-tight">Travertine Center Table</h4><p class="text-sm text-stone-500 mt-0.5 font-light">Solid Stone &bull; Matte</p></div>
                                            <div class="text-right"><p class="text-base font-normal text-stone-900 tracking-tight">AED 8,000</p></div>
                                        </div>

                                        <div id="fast-stack-container" class="flex flex-col mt-2 px-1">
                                            <div class="fast-item opacity-0 flex items-center gap-3 p-2 bg-white rounded-xl border border-stone-100 shadow-[0_2px_4px_rgba(0,0,0,0.02)]"><div class="w-8 h-8 bg-[#F5F4F2] rounded-lg border border-stone-200 flex items-center justify-center text-stone-400"><iconify-icon icon="solar:chair-linear" class="text-sm"></iconify-icon></div><div class="h-2 w-24 bg-stone-100 rounded-full"></div><div class="flex-1"></div><div class="h-2 w-8 bg-stone-100 rounded-full"></div></div>
                                            <div class="fast-item opacity-0 flex items-center gap-3 p-2 bg-white rounded-xl border border-stone-100 shadow-[0_2px_4px_rgba(0,0,0,0.02)]"><div class="w-8 h-8 bg-[#F5F4F2] rounded-lg border border-stone-200 flex items-center justify-center text-stone-400"><iconify-icon icon="solar:lamp-linear" class="text-sm"></iconify-icon></div><div class="h-2 w-32 bg-stone-100 rounded-full"></div><div class="flex-1"></div><div class="h-2 w-10 bg-stone-100 rounded-full"></div></div>
                                            <div class="fast-item opacity-0 flex items-center gap-3 p-2 bg-white rounded-xl border border-stone-100 shadow-[0_2px_4px_rgba(0,0,0,0.02)]"><div class="w-8 h-8 bg-[#F5F4F2] rounded-lg border border-stone-200 flex items-center justify-center text-stone-400"><iconify-icon icon="solar:bed-linear" class="text-sm"></iconify-icon></div><div class="h-2 w-20 bg-stone-100 rounded-full"></div><div class="flex-1"></div><div class="h-2 w-12 bg-stone-100 rounded-full"></div></div>
                                            <div class="fast-item opacity-0 flex items-center gap-3 p-2 bg-white rounded-xl border border-stone-100 shadow-[0_2px_4px_rgba(0,0,0,0.02)]"><div class="w-8 h-8 bg-[#F5F4F2] rounded-lg border border-stone-200 flex items-center justify-center text-stone-400"><iconify-icon icon="solar:mirror-linear" class="text-sm"></iconify-icon></div><div class="h-2 w-28 bg-stone-100 rounded-full"></div><div class="flex-1"></div><div class="h-2 w-8 bg-stone-100 rounded-full"></div></div>
                                            <div class="fast-item opacity-0 flex items-center gap-3 p-2 bg-white rounded-xl border border-stone-100 shadow-[0_2px_4px_rgba(0,0,0,0.02)]"><div class="w-8 h-8 bg-[#F5F4F2] rounded-lg border border-stone-200 flex items-center justify-center text-stone-400"><iconify-icon icon="solar:sofa-linear" class="text-sm"></iconify-icon></div><div class="h-2 w-24 bg-stone-100 rounded-full"></div><div class="flex-1"></div><div class="h-2 w-10 bg-stone-100 rounded-full"></div></div>
                                            <div class="fast-item opacity-0 flex items-center gap-3 p-2 bg-white rounded-xl border border-stone-100 shadow-[0_2px_4px_rgba(0,0,0,0.02)]"><div class="w-8 h-8 bg-[#F5F4F2] rounded-lg border border-stone-200 flex items-center justify-center text-stone-400"><iconify-icon icon="solar:box-linear" class="text-sm"></iconify-icon></div><div class="h-2 w-20 bg-stone-100 rounded-full"></div><div class="flex-1"></div><div class="h-2 w-8 bg-stone-100 rounded-full"></div></div>
                                        </div>
                                        ...
                                        <div class="checkout-anim-item opacity-0 flex gap-4 items-center p-3 rounded-2xl bg-white border border-stone-100 shadow-sm relative z-10" data-anim="summary">
                                            ...
                                            <div class="flex-1"><h4 class="font-normal text-stone-900 text-base tracking-tight">+ 14 other items</h4><p class="text-sm text-stone-500 mt-0.5 font-light">Full Apartment Package</p></div>
                                            <div class="text-right"><p class="text-base font-normal text-stone-900 tracking-tight">AED 79,500</p></div>
                                        </div>
                                        ...
                                        <div class="mt-8 relative pt-2 pb-2" id="milestones-container">
                                            ...
                                            <div class="milestone pl-16 relative mb-12" id="m1">
                                                <div class="absolute left-[8px] top-0 w-8 h-8 rounded-full border-2 border-stone-200 bg-white milestone-dot z-10 flex items-center justify-center text-stone-400 shadow-sm"><iconify-icon icon="solar:box-linear" class="text-lg" stroke-width="1.5"></iconify-icon></div>
                                                <div class="milestone-content"><span class="inline-block text-[10px] font-bold tracking-widest uppercase text-stone-500 bg-stone-200 rounded-full px-2.5 py-0.5 mb-1.5 milestone-badge">10% Deposit</span><h4 class="text-xl text-stone-900 font-normal tracking-tight mt-0.5">Manufacturing Started</h4></div>
                                            </div>

                                            <div class="milestone pl-16 relative mb-12" id="m2">
                                                <div class="absolute left-[8px] top-0 w-8 h-8 rounded-full border-2 border-stone-200 bg-white milestone-dot z-10 flex items-center justify-center text-stone-400 shadow-sm"><iconify-icon icon="solar:routing-linear" class="text-lg" stroke-width="1.5"></iconify-icon></div>
                                                <div class="milestone-content"><span class="inline-block text-[10px] font-bold tracking-widest uppercase text-stone-500 bg-stone-200 rounded-full px-2.5 py-0.5 mb-1.5 milestone-badge">20% Milestone</span><h4 class="text-xl text-stone-900 font-normal tracking-tight mt-0.5">Shipment on the Way</h4></div>
                                            </div>

                                            <div class="milestone pl-16 relative" id="m3">
                                                <div class="absolute left-[8px] top-0 w-8 h-8 rounded-full border-2 border-stone-200 bg-white milestone-dot z-10 flex items-center justify-center text-stone-400 shadow-sm"><iconify-icon icon="solar:home-angle-linear" class="text-lg" stroke-width="1.5"></iconify-icon></div>
                                                <div class="milestone-content" style="perspective: 1000px;">
                                                    <span class="inline-block text-[10px] font-bold tracking-widest uppercase text-stone-500 bg-stone-200 rounded-full px-2.5 py-0.5 mb-1.5 milestone-badge">70% Balance</span>
                                                    <h4 class="text-xl text-stone-900 font-normal tracking-tight mt-0.5">Handover Checkout</h4>
                                                    ...
                                                    <div class="finance-card-wrapper mt-5">
                                                        <div class="bg-white border border-stone-200 rounded-2xl p-6 shadow-xl relative cursor-default flex flex-col gap-6">
                                                            <div class="flex justify-between items-start">
                                                                <div><p class="text-sm text-stone-500 font-light hidden">Amount to finance</p><h4 class="font-normal text-stone-900 tracking-tight text-lg mt-1">AED 70,000</h4></div>
                                                                <div class="text-right"><p class="text-xs font-medium text-[#C96442] uppercase tracking-widest mb-1 hidden">Monthly</p><div class="text-2xl font-normal text-stone-900 tracking-tight" id="completion-price">AED 1,166</div></div>
                                                            </div>

                                                            <div class="flex flex-col gap-3">
                                                                <input type="range" min="0" max="60" value="60" class="w-full relative z-10" id="finance-slider">
                                                                <div class="flex justify-between w-full text-[10px] sm:text-xs text-stone-400 font-medium uppercase tracking-widest items-center"><span>Pay Now</span><span id="months-display" class="text-stone-700 bg-[#F5F4F2] px-2 py-1 rounded-md border border-stone-200 font-normal shadow-sm tracking-widest">60 MONTHS</span></div>
                                                            </div>

                                                            <button class="w-full bg-[#C96442] text-white py-3.5 rounded-xl font-normal tracking-widest uppercase text-sm hover:bg-[#A84F2E] transition-all flex items-center justify-center gap-2 shadow-[0_4px_12px_rgba(201,100,66,0.3)] hover:shadow-[0_6px_16px_rgba(28,25,23,0.4)] transform hover:-translate-y-0.5 duration-300 group">Lock Price<iconify-icon icon="solar:arrow-right-linear" class="text-lg group-hover:translate-x-1 transition-transform" stroke-width="1.5"></iconify-icon></button>
                                                        </div>
                                                    </div>
        ...
        <section id="faq" class="relative py-24 lg:py-32 bg-[#FAFAFA] border-t border-stone-200 overflow-hidden">
            <div class="max-w-7xl mx-auto px-6 relative z-10 text-center mb-16 lg:mb-24">
                <div class="inline-flex items-center justify-center gap-3 mb-6">
                    ...
                    <span class="uppercase text-xs font-medium tracking-[0.2em] text-[#D2754E] font-montserrat">Insights</span>
                </div>
                ...
                <p class="text-xl text-[#C96442] font-montserrat font-light max-w-3xl mx-auto leading-relaxed">Discover the answers to your heartfelt questions about our passionate design journey and the process that transforms your dreams into reality.</p>
            </div>
                ...
                <div id="faq-carousel" class="faq-carousel w-[280px] sm:w-[360px] h-[400px] sm:h-[480px] relative z-20">
                    <div class="faq-card-wrapper group is-active">
                        <div class="faq-card-inner">
                            <div class="faq-card-front bg-white/60 backdrop-blur-xl border border-stone-200 rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.05)] flex flex-col items-center justify-center p-8 text-center pulse-glow-wheel"><iconify-icon icon="solar:calendar-date-linear" class="text-4xl text-[#E8A07E] mb-6"></iconify-icon><h3 class="text-2xl sm:text-3xl font-playfair text-[#2C2B29] leading-snug">What is the typical timeline for a project?</h3><div class="absolute bottom-6 text-xs text-[#C96442] font-montserrat tracking-widest uppercase flex items-center gap-2">Tap to reveal <iconify-icon icon="solar:refresh-linear" class="text-sm"></iconify-icon></div></div>
                            <div class="faq-card-back bg-stone-900 rounded-3xl overflow-hidden shadow-2xl flex flex-col justify-end"><img src="https://images.unsplash.com/photo-1600210492486-724fe5c67fb0?w=800&q=80" class="absolute inset-0 w-full h-full object-cover z-0" alt="Luxurious Living Room"><div class="absolute inset-0 bg-gradient-to-t from-stone-900 via-stone-900/80 to-stone-900/40 z-10"></div><div class="relative z-20 p-6 sm:p-8 h-full flex flex-col"><h4 class="text-xl font-playfair text-white mb-4 border-b border-white/20 pb-4 shrink-0">Timeline</h4><div class="overflow-y-auto hide-scrollbar flex-1 pb-2"><p class="text-sm sm:text-base text-stone-200 font-montserrat font-light leading-relaxed">Every project is a unique story, shaped by the time it takes to embrace your vision and define the scope. Yet, the soul of our craftsmanship begins in the hands of our dedicated partners in China, where the furniture is lovingly crafted over 30-40 days. From there, a month-long sea voyage brings this masterpiece closer to you.</p></div></div></div>
                        </div>
                    </div>

                    <div class="faq-card-wrapper group">
                        <div class="faq-card-inner">
                            <div class="faq-card-front bg-white/60 backdrop-blur-xl border border-stone-200 rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.05)] flex flex-col items-center justify-center p-8 text-center pulse-glow-wheel"><iconify-icon icon="solar:tag-price-linear" class="text-4xl text-[#E8A07E] mb-6"></iconify-icon><h3 class="text-2xl sm:text-3xl font-playfair text-[#2C2B29] leading-snug">How do you determine pricing for a project?</h3><div class="absolute bottom-6 text-xs text-[#C96442] font-montserrat tracking-widest uppercase flex items-center gap-2">Tap to reveal <iconify-icon icon="solar:refresh-linear" class="text-sm"></iconify-icon></div></div>
                            <div class="faq-card-back bg-stone-900 rounded-3xl overflow-hidden shadow-2xl flex flex-col justify-end"><img src="https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=800&q=80" class="absolute inset-0 w-full h-full object-cover z-0" alt="Premium Fabric Swatches"><div class="absolute inset-0 bg-gradient-to-t from-stone-900 via-stone-900/80 to-stone-900/40 z-10"></div><div class="relative z-20 p-6 sm:p-8 h-full flex flex-col"><h4 class="text-xl font-playfair text-white mb-4 border-b border-white/20 pb-4 shrink-0">Pricing</h4><div class="overflow-y-auto hide-scrollbar flex-1 pb-2"><p class="text-sm sm:text-base text-stone-200 font-montserrat font-light leading-relaxed">Our pricing reflects more than just numbers; it embodies our commitment to quality, passion, and integrity. We carefully select premium materials that promise durability and a luxurious feel, without compromising your budget.</p></div></div></div>
                        </div>
                    </div>

                    <div class="faq-card-wrapper group">
                        <div class="faq-card-inner">
                            <div class="faq-card-front bg-white/60 backdrop-blur-xl border border-stone-200 rounded-3xl shadow-[0_8px_32px_rgba(0,0,0,0.05)] flex flex-col items-center justify-center p-8 text-center pulse-glow-wheel"><iconify-icon icon="solar:pen-new-square-linear" class="text-4xl text-[#E8A07E] mb-6"></iconify-icon><h3 class="text-2xl sm:text-3xl font-playfair text-[#2C2B29] leading-snug">Can I request revisions during the design process?</h3><div class="absolute bottom-6 text-xs text-[#C96442] font-montserrat tracking-widest uppercase flex items-center gap-2">Tap to reveal <iconify-icon icon="solar:refresh-linear" class="text-sm"></iconify-icon></div></div>
                            <div class="faq-card-back bg-stone-900 rounded-3xl overflow-hidden shadow-2xl flex flex-col justify-end"><img src="https://images.unsplash.com/photo-1618221195710-dd6b41faaea6?w=800&q=80" class="absolute inset-0 w-full h-full object-cover z-0" alt="Design Blueprints"><div class="absolute inset-0 bg-gradient-to-t from-stone-900 via-stone-900/80 to-stone-900/40 z-10"></div><div class="relative z-20 p-6 sm:p-8 h-full flex flex-col"><h4 class="text-xl font-playfair text-white mb-4 border-b border-white/20 pb-4 shrink-0">Revisions</h4><div class="overflow-y-auto hide-scrollbar flex-1 pb-2"><p class="text-sm sm:text-base text-stone-200 font-montserrat font-light leading-relaxed">Absolutely. Your vision is the heartbeat of our work. We welcome revisions and heartfelt conversations until you are entirely satisfied. Only when you are at peace with the design do we commit to bringing it to life.</p></div></div></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="lg:py-32 bg-white border-stone-200 border-t pt-24 pb-24 overflow-hidden relative">
            <div class="max-w-4xl mx-auto px-6 text-center relative z-10">
                <h2 id="cta-heading" class="lg:text-7xl xl:text-8xl leading-[1.05] text-5xl tracking-tight mb-12 flex flex-col font-normal items-center text-center w-full">
                    <span class="cta-bounce-enter block text-[#2C2B29] font-playfair">From concept.</span>
                    <span class="font-playfair text-[#D2754E] cta-bounce-enter block">To completion.</span>
                    <span class="font-playfair italic text-[#F0C2A6] cta-bounce-enter block">Casa Flow handles it all.</span>
                </h2>
                <p class="text-2xl text-stone-500 max-w-2xl mr-auto mb-12 ml-auto font-light">Consult Casa Flow today and transform your space flawlessly and financially comfortably with us.</p>
                <div class="flex flex-col sm:flex-row justify-center items-center gap-4">
                    <button class="sm:w-auto hover:bg-[#A84F2E] transition-colors flex btn-pulse text-xl font-normal text-white bg-[#C96442] w-full rounded-full pt-4 pr-8 pb-4 pl-8 relative gap-x-2 gap-y-2 items-center justify-center">Start it's Free</button>
                    <button class="sm:w-auto hover:bg-stone-50 transition-all flex text-xl font-normal text-stone-900 bg-white w-full border-stone-200 border rounded-full pt-4 pr-8 pb-4 pl-8 gap-x-2 gap-y-2 items-center justify-center">Call We Care</button>
                </div>
            </div>
        </section>
    </main>
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
                <div class="col-span-2 md:col-span-1">
                    <div class="flex items-center gap-1 mb-6"><span class="text-[#E8A07E] font-extralight tracking-widest text-xl uppercase">Casa</span><span class="text-[#C96442] font-normal text-xl tracking-tight -ml-1">Flow</span></div>
                    <p class="text-lg text-stone-500 max-w-xs font-light">Elevating spaces with effortless design and financing.</p>
                </div>
                <div><h4 class="text-base font-normal text-stone-900 mb-4 tracking-tight">Product</h4><ul class="space-y-3 text-lg font-light text-stone-500"><li><a href="#" class="hover:text-stone-900 transition-colors">Features</a></li><li><a href="#" class="hover:text-stone-900 transition-colors">Collections</a></li></ul></div>
                <div><h4 class="text-base font-normal text-stone-900 mb-4 tracking-tight">Company</h4><ul class="space-y-3 text-lg font-light text-stone-500"><li><a href="#" class="hover:text-stone-900 transition-colors">About Us</a></li><li><a href="#" class="hover:text-stone-900 transition-colors">Designers</a></li></ul></div>
            ...
            <div class="border-t border-stone-200 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
                <p class="text-lg font-light text-stone-400">&copy; 2024 Casa Flow App. All rights reserved.</p>
                <div class="flex items-center gap-4 text-stone-400"><a href="#" class="hover:text-stone-900 transition-colors"><i data-lucide="twitter" stroke-width="1.5" class="w-6 h-6"></i></a><a href="#" class="hover:text-stone-900 transition-colors"><i data-lucide="instagram" stroke-width="1.5" class="w-6 h-6"></i></a></div>
            </div>
        </div>
    </footer>
`;
